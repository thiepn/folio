...
function habit(partial: Partial<HabitEntity>): HabitEntity {
  return { id: 'h', title: 'Habit', description: '', kind: 'check', target: 1, schedule: { type: 'daily' }, countsTowardCapacity: false, archived: false, sortOrder: 1, createdAt: '2026-08-01T10:00:00.000Z', updatedAt: now, ...partial }
}
