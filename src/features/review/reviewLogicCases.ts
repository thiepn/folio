...
const baseTask = (partial: Partial<TaskEntity>): TaskEntity => ({
  id: crypto.randomUUID(), title: 'Task', description: '', priority: 'normal', status: 'todo', tags: [], checklist: [], progressMode: 'auto', progressPercent: 0, pinned: false, comments: [], activity: [], sortOrder: 1,
