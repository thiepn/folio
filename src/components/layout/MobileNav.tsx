...
export function MobileNav({ active, onNavigate, onAdd, onMore }: {
  ...
  const moreActive = active === 'search' || active === 'projects' || active === 'lists' || active === 'notes' || active === 'habits' || active === 'automation' || active === 'share' || active === 'integrations' || active === 'matrix' || active === 'analytics' || active === 'review'
  return (
