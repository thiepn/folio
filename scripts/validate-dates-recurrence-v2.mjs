...
check('interop retains v17 restore compatibility', interop.includes('Schema v24 · complete planner state + rich content · sync credentials excluded') && interop.includes('schema v8–v24'))
