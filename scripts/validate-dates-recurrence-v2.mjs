...
check('interop retains v17 restore compatibility', interop.includes('Schema v23 · complete planner state + rich content + Habits V2 + Focus V2') && interop.includes('schema v8–v23'))
