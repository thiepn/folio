...
check('visible backup copy says v22', interop.includes('Schema v22 · complete planner state + rich content + Habits V2'))
...
for (const p of [
  ...
  'public/schema/folio-backup-v22.schema.json',
