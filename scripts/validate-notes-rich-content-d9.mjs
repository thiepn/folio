...
check('quota pressure checked before writes',attachmentService.includes('navigator.storage')&&attachmentService.includes('QUOTA_HEADROOM_BYTES'))
...
check('content search indexes attachment metadata',search.includes('attachmentText')&&search.includes('rebuildOwner'))
