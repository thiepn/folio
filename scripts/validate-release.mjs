...
check('CI uploads build artifact', ci.includes('actions/upload-artifact@ea165f8d65b6e75b540449e92b4886f43607fa02'))
...
check('Pages uses configure-pages v6', pages.includes('actions/configure-pages@45bfe0192ca1faeb007ade9deae92b16b8254a0d'))
check('Pages uploads dist only', /path:\s*dist\b/.test(pages))
check('Pages uses upload-pages-artifact v4', pages.includes('actions/upload-pages-artifact@7b1f4a764d45c48632c6b24a0339c27f5614fb0b'))
check('Pages uses deploy-pages v5', pages.includes('actions/deploy-pages@368f82528645a54fb793d4d04e342629a3f51346'))
